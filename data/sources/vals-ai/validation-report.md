...
- `cua_bench` (not auto-promoted)
- `mysterymechanism` (not auto-promoted)
...
- `terminal-bench-4` (not auto-promoted)
- `terminal-bench-science` (not auto-promoted)
- `vcb-1-100` (not auto-promoted)
...
- grok/grok-voice-transcribe-1.0
