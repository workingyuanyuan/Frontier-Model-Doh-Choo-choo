...
| `data-v2/product/versions/`、`.agents/`                         | 空目錄，已移除                                                                                |
...
- `data-v2` 出現在 56 個追蹤檔、182 處，含 `.github/workflows/pages.yml`、
...
`data-v2/sources/` 下 `lech-writing`、`llm-stats`、`openai`、`osworld`、`scale-hle`、
