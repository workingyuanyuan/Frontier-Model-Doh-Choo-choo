...
### Scale N = 19 (11 complete models)

- **Chosen Benchmarks (19)**: `aa-briefcase`, `aa-lcr`, `aa-omniscience`, `aime`, `chess-puzzles`, `critpt`, `deepswe-1-1`, `frontier-code-1-1`, `gdpval-aa`, `gpqa-diamond`, `humanitys-last-exam`, `livebench-instruction-following`, `livebench-language`, `livebench-mathematics`, `livebench-reasoning`, `scicode`, `simpleqa-verified`, `tau3-banking`, `terminal-bench-2-1`
- **Covered Dimensions (8/8)**: reasoning, math, knowledge, language, instruction, coding, agentic, context
- **Complete Models (11)**:
  - `anthropic-claude-fable-5` (Claude Fable 5)
  - `anthropic-claude-opus-5` (Claude Opus 5)
...
### Scale N = 20 (3 complete models)

- **Chosen Benchmarks (20)**: `aa-briefcase`, `aa-lcr`, `aa-omniscience`, `aime`, `chess-puzzles`, `critpt`, `deepswe-1-1`, `frontier-code-1-1`, `gdpval-aa`, `gpqa-diamond`, `humanitys-last-exam`, `ifbench`, `livebench-instruction-following`, `livebench-language`, `livebench-mathematics`, `livebench-reasoning`, `scicode`, `simpleqa-verified`, `tau3-banking`, `terminal-bench-2-1`
- **Covered Dimensions (8/8)**: reasoning, math, knowledge, language, instruction, coding, agentic, context
- **Complete Models (3)**:
  - `anthropic-claude-fable-5` (Claude Fable 5)
  - `openai-gpt-5-6-sol` (GPT-5.6 Sol)
...
- **Chosen Benchmarks (22)**: `aa-briefcase`, `aa-lcr`, `aa-omniscience`, `aime`, `apex-agents`, `chess-puzzles`, `critpt`, `deepswe-1-1`, `frontier-code-1-1`, `gdpval-aa`, `gpqa-diamond`, `humanitys-last-exam`, `ifbench`, `livebench-instruction-following`, `livebench-language`, `livebench-mathematics`, `livebench-reasoning`, `scicode`, `simpleqa-verified`, `swe-bench`, `tau3-banking`, `terminal-bench-2-1`
- **Covered Dimensions (8/8)**: reasoning, math, knowledge, language, instruction, coding, agentic, context
- **Complete Models (1)**:
  - `zai-glm-5-2` (GLM-5.2)

### Scale N = 23 (0 complete models)

- **Chosen Benchmarks (23)**: `aa-briefcase`, `aa-lcr`, `aa-omniscience`, `aime`, `apex-agents`, `chess-puzzles`, `critpt`, `deepswe-1-1`, `frontier-code-1-1`, `frontiermath`, `gdpval-aa`, `gpqa-diamond`, `humanitys-last-exam`, `ifbench`, `livebench-instruction-following`, `livebench-language`, `livebench-mathematics`, `livebench-reasoning`, `scicode`, `simpleqa-verified`, `swe-bench`, `tau3-banking`, `terminal-bench-2-1`
- **Covered Dimensions (8/8)**: reasoning, math, knowledge, language, instruction, coding, agentic, context
- **Complete Models (0)**:
  - _(None)_
...
| Model                    | Model ID                          | Total | `aa-briefcase` | `aa-lcr` | `aa-omniscience` | `aime` | `apex-agents` | `chess-puzzles` | `critpt` | `deepswe-1-1` | `frontier-code-1-1` | `frontiermath` | `gdpval-aa` | `gpqa-diamond` | `humanitys-last-exam` | `ifbench` | `livebench-instruction-following` | `livebench-language` | `livebench-mathematics` | `livebench-reasoning` | `scicode` | `simpleqa-verified` | `swe-bench` | `tau3-banking` | `terminal-bench-2-1` |
| ------------------------ | --------------------------------- | ----: | :------------: | :------: | :--------------: | :----: | :-----------: | :-------------: | :------: | :-----------: | :-----------------: | :------------: | :---------: | :------------: | :-------------------: | :-------: | :-------------------------------: | :------------------: | :---------------------: | :-------------------: | :-------: | :-----------------: | :---------: | :------------: | :------------------: |
| Qwen3.6 27B              | `alibaba-qwen3-6-27b`             | 17/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       -       |          -          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| Qwen3.6 Plus             | `alibaba-qwen3-6-plus`            |  4/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       -       |          -          |       -        |      -      |       -        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          -          |      -      |       -        |          -           |
| Qwen 3.7 Max             | `alibaba-qwen3-7-max`             |  9/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          -          |       -        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| Qwen3.7 Plus             | `alibaba-qwen3-7-plus`            | 14/23 |       -        |    ✓     |        ✓         |   ✓    |       ✓       |        ✓        |    ✓     |       -       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 -                 |          -           |            -            |           -           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| Qwen3.8 27B              | `alibaba-qwen3-8-27b`             | 13/23 |       -        |    ✓     |        ✓         |   -    |       -       |        -        |    ✓     |       -       |          -          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| Qwen3.8 Max              | `alibaba-qwen3-8-max`             | 18/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          -          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Claude Fable 5           | `anthropic-claude-fable-5`        | 20/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Claude Mythos Preview    | `anthropic-claude-mythos-preview` |  0/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       -       |          -          |       -        |      -      |       -        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          -          |      -      |       -        |          -           |
| Claude Opus 4.5          | `anthropic-claude-opus-4-5`       | 10/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| Claude Opus 4.6          | `anthropic-claude-opus-4-6`       | 11/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          ✓          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| Claude Opus 4.7          | `anthropic-claude-opus-4-7`       | 11/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          ✓          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| Claude Opus 4.8          | `anthropic-claude-opus-4-8`       | 11/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       ✓       |          ✓          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      -      |       -        |          -           |
| Claude Opus 5            | `anthropic-claude-opus-5`         | 19/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Claude Sonnet 4.6        | `anthropic-claude-sonnet-4-6`     | 12/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       ✓       |          ✓          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| Claude Sonnet 5          | `anthropic-claude-sonnet-5`       | 19/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| DeepSeek V4              | `deepseek-deepseek-v4`            |  0/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       -       |          -          |       -        |      -      |       -        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          -          |      -      |       -        |          -           |
| DeepSeek V4 Flash        | `deepseek-deepseek-v4-flash`      | 19/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| DeepSeek V4 Pro          | `deepseek-deepseek-v4-pro`        | 19/23 |       -        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      ✓      |       ✓        |          ✓           |
| Gemini 3.1 Pro Preview   | `google-gemini-3-1-pro-preview`   | 22/23 |       ✓        |    ✓     |        ✓         |   ✓    |       ✓       |        ✓        |    ✓     |       ✓       |          -          |       ✓        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      ✓      |       ✓        |          ✓           |
| Gemini 3.5 Flash         | `google-gemini-3-5-flash`         | 11/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       ✓       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| Gemini 3.5 Flash-Lite    | `google-gemini-3-5-flash-lite`    | 16/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       -       |          -          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| Gemini 3.6 Flash         | `google-gemini-3-6-flash`         | 19/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Gemini 3.7 Flash         | `google-gemini-3-7-flash`         | 19/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Gemini 3 Pro Preview     | `google-gemini-3-pro-preview`     |  6/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          ✓          |      ✓      |       -        |          -           |
| Muse Spark               | `meta-muse-spark`                 |  4/23 |       -        |    -     |        -         |   ✓    |       -       |        -        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          ✓          |      -      |       -        |          -           |
| Muse Spark 1.1           | `meta-muse-spark-1-1`             |  5/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       ✓       |          -          |       -        |      -      |       -        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          -          |      -      |       -        |          -           |
| Muse Spark 1.2           | `meta-muse-spark-1-2`             | 15/23 |       ✓        |    ✓     |        ✓         |   -    |       -       |        -        |    ✓     |       ✓       |          -          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| MiniMax M3               | `minimax-minimax-m3`              | 18/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       -       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| Kimi K2.6                | `moonshot-kimi-k2-6`              | 10/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| Kimi K2.7 Code           | `moonshot-kimi-k2-7-code`         | 18/23 |       -        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          -          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Kimi K3                  | `moonshot-kimi-k3`                | 20/23 |       ✓        |    ✓     |        ✓         |   ✓    |       ✓       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Nemotron 3 Ultra         | `nvidia-nemotron-3-ultra`         | 11/23 |       ✓        |    ✓     |        ✓         |   -    |       -       |        -        |    ✓     |       -       |          -          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 -                 |          -           |            -            |           -           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| GPT-5.2                  | `openai-gpt-5-2`                  | 10/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| GPT-5.2 Codex            | `openai-gpt-5-2-codex`            |  4/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       -       |          -          |       -        |      -      |       -        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          -          |      -      |       -        |          -           |
| GPT-5.2 Pro              | `openai-gpt-5-2-pro`              |  1/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       -       |          -          |       ✓        |      -      |       -        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          -          |      -      |       -        |          -           |
| GPT-5.3 Codex            | `openai-gpt-5-3-codex`            |  1/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       -       |          -          |       -        |      -      |       -        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          -          |      ✓      |       -        |          -           |
| GPT-5.4                  | `openai-gpt-5-4`                  | 11/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       ✓       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| GPT-5.4 mini             | `openai-gpt-5-4-mini`             | 10/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          ✓          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      -      |       -        |          -           |
| GPT-5.4 nano             | `openai-gpt-5-4-nano`             |  9/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      -      |       -        |          -           |
| GPT-5.4 Pro              | `openai-gpt-5-4-pro`              |  4/23 |       -        |    -     |        -         |   -    |       -       |        ✓        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          ✓          |      -      |       -        |          -           |
| GPT-5.5                  | `openai-gpt-5-5`                  | 12/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       ✓       |          ✓          |       ✓        |      -      |       ✓        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          ✓          |      ✓      |       -        |          -           |
| GPT-5.5 Pro              | `openai-gpt-5-5-pro`              |  6/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    ✓     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          ✓          |      -      |       -        |          -           |
| GPT-5.6 Luna             | `openai-gpt-5-6-luna`             | 19/23 |       -        |    ✓     |        ✓         |   ✓    |       ✓       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| GPT-5.6 Sol              | `openai-gpt-5-6-sol`              | 20/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| GPT-5.6 Terra            | `openai-gpt-5-6-terra`            | 20/23 |       -        |    ✓     |        ✓         |   ✓    |       ✓       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Inkling                  | `thinking-machines-inkling`       | 18/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       -       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Grok 4.3                 | `xai-grok-4-3`                    | 14/23 |       -        |    ✓     |        ✓         |   -    |       -       |        -        |    ✓     |       -       |          -          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| Grok 4.5                 | `xai-grok-4-5`                    | 19/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Grok 4.6                 | `xai-grok-4-6`                    | 19/23 |       ✓        |    ✓     |        ✓         |   ✓    |       -       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      -      |       ✓        |          ✓           |
| Grok Build 0.1           | `xai-grok-build-0-1`              |  4/23 |       -        |    -     |        -         |   -    |       -       |        -        |    -     |       -       |          -          |       -        |      -      |       -        |           -           |     -     |                 ✓                 |          ✓           |            ✓            |           ✓           |     -     |          -          |      -      |       -        |          -           |
| MiMo V2.5 Pro            | `xiaomi-mimo-v2-5-pro`            | 12/23 |       ✓        |    ✓     |        ✓         |   -    |       ✓       |        -        |    ✓     |       -       |          -          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 -                 |          -           |            -            |           -           |     ✓     |          -          |      -      |       ✓        |          ✓           |
| GLM-5.1                  | `zai-glm-5-1`                     |  6/23 |       -        |    -     |        -         |   ✓    |       -       |        ✓        |    -     |       -       |          -          |       ✓        |      -      |       ✓        |           -           |     -     |                 -                 |          -           |            -            |           -           |     -     |          ✓          |      ✓      |       -        |          -           |
| GLM-5.2                  | `zai-glm-5-2`                     | 22/23 |       ✓        |    ✓     |        ✓         |   ✓    |       ✓       |        ✓        |    ✓     |       ✓       |          ✓          |       -        |      ✓      |       ✓        |           ✓           |     ✓     |                 ✓                 |          ✓           |            ✓            |           ✓           |     ✓     |          ✓          |      ✓      |       ✓        |          ✓           |
| **Total Models Covered** | —                                 |     — |     **20**     |  **27**  |      **27**      | **39** |     **7**     |     **39**      |  **28**  |    **24**     |       **23**        |     **19**     |   **27**    |     **45**     |        **27**         |  **12**   |              **41**               |        **41**        |         **41**          |        **41**         |  **27**   |       **36**        |   **16**    |     **27**     |        **27**        |
