...
- Historical judgment evidence is also pinned at revision `5896e3b11081702c7f93f4733605fa4f5a072a11` (2024-10-22): 93,624 rows, all six categories, 1,152,090 bytes and artifact SHA-256 `8f490d557d86b5dab0da9db1169142f69ebe69907fbaba361b4f00e4fe4f171d`.
- The two fixed judgment revisions cover 318 and 700 target observation keys respectively; their union covers 800/1,000. Two real acquisitions emitted identical 3,018-byte prompt/model/score-free manifests at SHA-256 `c80ea84bba3be46ac2a9c6bf5203422a76f5ab0181f0a04c908c0e942125dda5`.
- The official generator versions aligned to the two artifact dates already de-duplicate task JSONL by `(question_id, model)` while preserving the last file occurrence: April commit `a41783c06f646697a96cc2ae2275a6b5c2646cb4` and October commit `4de3327329bcf9a5d00d800b92796b78519798ec`. The published Parquet schema omits answer/run/version IDs, so neither file order nor `tstamp` is accepted as a cross-alias precedence key.
